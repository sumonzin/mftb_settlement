...
namespace ACE.Banking.MPU.Businesslogic
{
    ...
    public class MPU_Settlement_InfoController
    {
        ...
        private void Filll(IDataReader dataReader, MPU_Settlement_InfoInfo mPU_Settlement_InfoInfo)
        {
        ...
        public MPU_Settlement_InfoCollections SelectCore_EcomandPOSACQ(string SettlementDate)
        {
            IDataReader dataReader = DataController.SelectCore_EcomandPOSACQ(SettlementDate);
            MPU_Settlement_InfoCollections mPU_Settlement_InfoCollections = new MPU_Settlement_InfoCollections();
        ...
        public MPU_Settlement_InfoCollections SelectCore_EcomandPOSISS(string SettlementDate)
        {
            IDataReader dataReader = DataController.SelectCore_EcomandPOSISS(SettlementDate);
            MPU_Settlement_InfoCollections mPU_Settlement_InfoCollections = new MPU_Settlement_InfoCollections();
